...
You don't have to worry about downloading the data, it will be automatically downloaded from the `HomeCreditDefaultRisk.ipynb` notebook.

## Technical aspects

To develop this Machine Learning model you will interact primarly through a Jupyter notebook called `HomeCreditDefaultRisk.ipynb`. This notebook will act as a guide through all the steps to follow and the code needed to complete the different parts of the project.
